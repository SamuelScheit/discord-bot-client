...
export default new class DiscordComponents {
    ...
    constructor() {
        Patcher.after("DiscordComponents", React, "createElement", (_, __, returnValue) => {
            this.walkRenderTree(returnValue);
        });
        Patcher.instead("DiscordComponents", React.Component.prototype, "componentWillMount", (thisObject) => {
            this.addComponent(thisObject.constructor);
        });
        Patcher.instead("DiscordComponents", React.Component.prototype, "UNSAFE_componentWillMount", (thisObject) => {
            this.addComponent(thisObject.constructor);
        });

        Patcher.instead("DiscordComponents", React.PureComponent.prototype, "componentWillMount", (thisObject) => {
            this.addComponent(thisObject.constructor);
        });
        Patcher.instead("DiscordComponents", React.PureComponent.prototype, "UNSAFE_componentWillMount", (thisObject) => {
            this.addComponent(thisObject.constructor);
        });
    }
